 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int capi_pint_configure_pin(struct capi_pint_port_handle *handle, uint8_t pin_index,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int capi_pint_enable_pin(struct capi_pint_port_handle *handle, uint8_t pin_index);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int capi_pint_disable_pin(struct capi_pint_port_handle *handle, uint8_t pin_index);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int capi_pint_register_callback(struct capi_pint_port_handle *handle, uint8_t pin_index,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int capi_pint_unregister_callback(struct capi_pint_port_handle *handle, uint8_t pin_index);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int capi_pint_clear_pending(struct capi_pint_port_handle *handle, uint8_t pin_index);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int capi_pint_get_pending(struct capi_pint_port_handle *handle, uint32_t *pending);
...
struct capi_pint_ops {
	...
	int (*register_callback)(struct capi_pint_port_handle *handle, uint8_t pin_index,
				 capi_pint_callback_t callback, void *user_data);
	/** See capi_pint_unregister_callback() */
	int (*unregister_callback)(struct capi_pint_port_handle *handle, uint8_t pin_index);
