...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->get_datetime != NULL) {
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->set_datetime != NULL) {
...
int capi_rtc_disable_alarm(struct capi_rtc_handle *handle, enum capi_rtc_alarm_type type)
{
	if (handle != NULL && handle->ops != NULL && handle->ops->disable_alarm != NULL) {
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->sqwave_enable != NULL) {
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->sqwave_disable != NULL) {
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->enable_event != NULL) {
		return handle->ops->enable_event(handle, event);
	}
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->disable_event != NULL) {
		return handle->ops->disable_event(handle, event);
	}
