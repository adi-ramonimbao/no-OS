...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->generate_u32 != NULL) {
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->fill_buffer_async != NULL) {
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->abort_async != NULL) {
		return handle->ops->abort_async(handle);
	}
...
{
	if (handle != NULL && handle->ops != NULL && handle->ops->is_busy != NULL) {
		return handle->ops->is_busy(handle, is_busy);
	}
