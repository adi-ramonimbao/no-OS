# Marks trustzone_hello as a Secure TrustZone application.
#
...
# (no_os_add_{maxim,stm32}_trustzone_app) then drives the Secure outer /
# Non-Secure nested superbuild. The nested Non-Secure tree passes
# MSECURITY_MODE=NONSECURE explicitly, so the top-level guard skips this
# marker there.
set(MSECURITY_MODE SECURE CACHE STRING "TrustZone security world")

# --- Custom TrustZone memory settings (optional, Maxim only) ---------------------
...
#
# These are cache variables read by drivers/platform/maxim/toolchain.cmake (STM32
# has no equivalent yet -- its linker scripts come from CubeMX generation, not a
# static SDK). Prefer passing overrides on the cmake line (e.g.
# -DUSE_CUSTOM_MEMORY_SETTINGS=1 -DNS_FLASH_SIZE=0x000a0000); editing values here
# after a build is configured needs a fresh build directory to take effect (the
# cache is not force-overwritten).
