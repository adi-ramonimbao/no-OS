# Marks trustzone_nonsecure_only as a Non-Secure TrustZone application.
#
...
# and merges its image with the Secure HEX, both produced by trustzone_secure_only.
# Supply them on the cmake line (preferred, keeps paths out of the tree):
#   -DSECURE_CONTRACT=/abs/.../trustzone_secure_only_contract.cmake
...
#
# set(SECURE_CONTRACT "/abs/path/to/trustzone_secure_only_contract.cmake"
#     CACHE FILEPATH "Producer contract (sets TZ_SECURE_HEX + TZ_SECURE_IMPLIB)")
#
# set(SECURE_HEX    "/abs/path/to/trustzone_secure_only.hex"
#     CACHE FILEPATH "Secure image to merge with the Non-Secure image")
# set(SECURE_IMPLIB "/abs/path/to/trustzone_secure_only_implib.o"
