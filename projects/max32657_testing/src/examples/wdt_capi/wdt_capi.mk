...
INCS +=	${NO-OS}/capi/inc/capi_alloc.h \
	...
	$(NO-OS)/capi/platform/maxim/max32657/maxim_capi_wdt.h \
...
SRCS +=	${NO-OS}/capi/src/capi_alloc.c \
	...
	$(NO-OS)/capi/platform/maxim/max32657/maxim_capi_wdt.c \
